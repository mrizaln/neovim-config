...
packer.init({
	compile_path = packer.util.join_paths(vim.fn.stdpath("config"), "lua", "config", "packer_compiled.lua"),
...
-- code outline (this one seems to not show the function parameters, not as useful)
--[[ use({
